...
arguments* is what catches it, and it catches renames and removals too.
...
def _bind(target: Callable[..., Any], args: Sequence[Any], kwargs: dict[str, Any]) -> str | None:
...
class RecordingPluginContext:
    ...
    def _record(self, registrar: str, args: tuple[Any, ...], kwargs: dict[str, Any]) -> None:
        ...
        detail = _bind(target, args, kwargs)
